...
function Authentication() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-[#131d30]">
            ...
            >
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-2 pr-10 rounded bg-[#142435] text-white placeholder-gray-400 focus:outline-none"
                />
                <button
                  type="button"
